...
<h3 align="center">Full Stack AI Engineer | MLOps | Open Source Enthusiast</h3>

<p align="center">
Transforming complex data into interactive experiences. I'm a Full Stack Developer with a specialized background in AI, capable of embedding real-time image processing and LLM-driven features directly into modern web architectures. I don't just build websites; I build systems that think.
</p>
...
- 🏢 **Program Associate II** at [IITGN](https://iitgn.ac.in/) R&D | Specializing in Data Pipelines & AI
- 🎓 **MTech in Computer Science & Engineering** from [IITGN](https://iitgn.ac.in/) | Specialization: Computer Vision (CPI: 8.25)
- 🎓 **BTech in Computer Science** from [NERIST](https://nerist.ac.in/) (CPI: 9.43)
- 🤖 **Expertise**: Computer Vision, NLP, Data Pipelines & Full Stack AI
- 🔧 **Skills**: Python, C++, Go, Java | TensorFlow, PyTorch, Scikit-learn | React, Next.js, Node.js | Docker, Kubernetes
